...
--
-- Host: localhost    Database: reservaciones_anp
-- ------------------------------------------------------
...
--
-- Dumping data for table `detalles_reservaciones`
--

LOCK TABLES `detalles_reservaciones` WRITE;
/*!40000 ALTER TABLE `detalles_reservaciones` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `detalles_reservaciones` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `disponibilidades_lugares_gruposservicios`
--

LOCK TABLES `disponibilidades_lugares_gruposservicios` WRITE;
/*!40000 ALTER TABLE `disponibilidades_lugares_gruposservicios` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `disponibilidades_lugares_gruposservicios` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `grupos_disponibilidades`
--

LOCK TABLES `grupos_disponibilidades` WRITE;
/*!40000 ALTER TABLE `grupos_disponibilidades` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `grupos_disponibilidades` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `periodos_deshabilitados`
--

LOCK TABLES `periodos_deshabilitados` WRITE;
/*!40000 ALTER TABLE `periodos_deshabilitados` DISABLE KEYS */;
INSERT INTO `periodos_deshabilitados` VALUES (1,1,'1970-01-01','2023-01-01','2023-04-24 19:48:34','2023-04-24 19:48:34',0);
/*!40000 ALTER TABLE `periodos_deshabilitados` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-05-18  8:39:17
